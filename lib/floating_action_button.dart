...
class FloatActionButton extends StatefulWidget {
  @override
  FloatActionButtonState createState() => new FloatActionButtonState();
}

class FloatActionButtonState extends State<FloatActionButton> with TickerProviderStateMixin {
  int _angle = 90;
